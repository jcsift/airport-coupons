<a id="airport-coupon-guide"></a>

# 机场优惠码与折扣汇总

购买机场套餐前，可以在本页查找对应的**优惠码、专属折扣和新人优惠**，并核对账户、付款周期与套餐限制。复制表内优惠码，再到官网结算页填写；点击机场名称可查看完整评测、套餐价格与测速。

[机场卡片汇总](https://github.com/jcsift/airport-cards) · [机场评测与套餐汇总](https://github.com/jcsift/airport-summary)

<a id="all-airport-coupons"></a>
...
以下机场已收录套餐与评测，但本站暂未收录优惠码，可通过详情页和官网查看套餐活动。
...
1. 先查看适用条件，确认新用户、首次购买、付款周期和套餐限制。
...
<a id="coupon-period-discount-stacking"></a>

### 优惠码能与年付、两年付等周期折扣叠加吗？

是否叠加需查看对应机场的结算结果，不能仅凭两项折扣分别存在就直接相乘。[星岛梦](https://eoht.net/serve/airport/xdm)和[飞猫云](https://eoht.net/serve/airport/flycat)均另列周期优惠，实际可用优惠码、叠加方式与付款总额应在选定套餐后确认。

<a id="coupon-annual-mini-plan-limits"></a>
...
先区分“新用户”“新客首单”和“全场套餐”等适用条件，不能把新人优惠直接套用到续费。[微风网络](https://eoht.net/serve/airport/breeze)明确支持新老用户新购、续费及升级；其他机场按表内条件与结算页说明选择。

继续比较套餐，可查看[机场卡片汇总](https://github.com/jcsift/airport-cards)或[机场评测与套餐汇总](https://github.com/jcsift/airport-summary)。
